...
function AuthDialogContent({ isOpen, onClose, activeTab, setActiveTab, onAuthSuccess }: AuthDialogContentProps) {
  ...
  const getDialogTitle = () => {
    switch (authView) {
      ...
      case "register": return t('landing.auth.createAccount');
      case "forgot-password": return "Reset password";
      case "reset-password": return "New password";
      default: return t('landing.auth.signIn');
    }
  };
  ...
  const getDialogDescription = () => {
    switch (authView) {
      ...
      case "register": return "Get started with AI-powered hiring";
      ...
      return (
        <form onSubmit={handleForgotPasswordSendOTP} className="space-y-4">
          <div className="text-center space-y-3 mb-6">
            ...
            <div>
              <h3 className="font-semibold text-lg">{t('landing.auth.forgotPassword')}</h3>
          ...
          <div className="space-y-2">
            <Label htmlFor="forgot-email">{t('landing.auth.email')}</Label>
            <Input
              id="forgot-email"
              type="email"
      ...
      <DialogContent hideCloseButton className="sm:max-w-[440px] p-0 gap-0 overflow-hidden rounded-2xl border shadow-2xl bg-background" data-testid="dialog-auth">
        ...
        {isLoading && (
          ...
          >
            ...
            >
              <div className="w-12 h-12 border-4 border-slate-200 dark:border-slate-700 border-t-indigo-500 rounded-full" />
            </motion.div>
            <motion.div
          ...
          {authView === "login" ? (
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Sign in to manage your hiring platform
                </p>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground text-sm">
                ...
                {forgotPasswordStep === "otp" && t('landing.auth.verificationCode')}
                {forgotPasswordStep === "new-password" && t('landing.auth.newPassword')}
              </p>
            </div>
          ) : (
            <div className="space-y-3">
              ...
              <div>
                <h2 className="text-xl font-bold">{t('landing.auth.createAccount')}</h2>
                <p className="text-muted-foreground text-sm">
            ...
            <div className="">
              <Tabs value={activeTab} onValueChange={(v) => {
                ...
                <TabsList className="grid w-full grid-cols-2 mb-6">
                  <TabsTrigger value="login" data-testid="tab-login">{t('landing.auth.signIn')}</TabsTrigger>
                  <TabsTrigger value="register" data-testid="tab-register">{t('landing.auth.createAccountBtn')}</TabsTrigger>
                </TabsList>
                
                <TabsContent value="login" className="mt-0">
                  <form onSubmit={handleLogin} className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="dialog-login-email">{t('landing.auth.email')}</Label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <Label htmlFor="dialog-login-password">{t('landing.auth.password')}</Label>
                        <button
                          type="button"
                ...
                <TabsContent value="register" className="mt-0">
                  {signupStep === "details" ? (
                    <form onSubmit={handleSendOTP} className="space-y-4">
                      <div className="space-y-2">
                        <Label htmlFor="dialog-register-name">{t('landing.auth.fullName')}</Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="dialog-register-email">{t('landing.auth.email')}</Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="dialog-register-password">{t('landing.auth.password')}</Label>
                        <div className="relative">
                          <Input
