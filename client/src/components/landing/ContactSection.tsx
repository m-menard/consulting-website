...
const TrustElement = ({ icon: Icon, text, testId }: TrustElementProps) => (
  ...
  >
    <div className="h-10 w-10 rounded-lg bg-blue-50 flex items-center justify-center flex-shrink-0">
      <Icon className="h-5 w-5 text-[#176BD0]" />
    </div>
...
export function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="py-12 sm:py-16 md:py-24 lg:py-32 relative overflow-hidden bg-white"
        ...
        >
          ...
          >
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 text-[#176BD0] text-sm font-medium">
              ...
              <p
                className="text-sm sm:text-base md:text-lg text-slate-600 leading-relaxed max-w-lg"
            ...
            <div className="space-y-6">
              ...
              >
                <div className="h-14 w-14 rounded-2xl bg-[#176BD0] flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform shadow-lg shadow-blue-500/20">
          ...
          <motion.div variants={shouldReduceMotion ? {} : itemVariants}>
            <Card className="p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-xl border border-slate-200 bg-white" data-testid="card-contact-form">
              <Form {...form}>
                <form
                ...
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-slate-700">{t('landing.contact.form.nameLabel')}</FormLabel>
                        <FormControl>
                          <Input
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-slate-700">{t('landing.contact.form.emailLabel')}</FormLabel>
                        <FormControl>
                          <Input
                            type="email"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-slate-700">{t('landing.contact.form.companyLabel')}</FormLabel>
                        <FormControl>
                          <Input
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-slate-700">{t('landing.contact.form.messageLabel')}</FormLabel>
                        <FormControl>
                          <Textarea
                            placeholder={t('landing.contact.form.messagePlaceholder')}
                            className="min-h-[140px] resize-none bg-slate-50 border-slate-200"
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full h-12 text-base font-semibold bg-[#176BD0] text-white border-0 shadow-lg shadow-blue-500/20"
