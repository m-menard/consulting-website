...
const technologies = [
  {
    ...
    color: "from-violet-600 to-indigo-600 dark:from-violet-500 dark:to-indigo-500"
  },
  {
    icon: Mic2,
  ...
  },
  {
    ...
    color: "from-indigo-500 to-violet-500 dark:from-indigo-400 dark:to-violet-400"
  }
];
...
export function AITechnologyShowcase() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-100/20 via-transparent to-violet-50/10 dark:from-indigo-900/10 dark:via-transparent dark:to-violet-900/5" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <Badge 
            className="bg-gradient-to-r from-violet-600 to-indigo-500 text-white border-0 mb-4"
          ...
          >
            Built for the <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-indigo-500">Future</span> of Communication
          </h2>
          ...
          {technologies.map((item, index) => (
            ...
            >
              <Card className="p-4 sm:p-6 md:p-8 rounded-2xl md:rounded-3xl hover-elevate transition-all h-full group relative overflow-hidden">
                ...
                <motion.div 
                  className={`h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 rounded-xl md:rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center mb-4 sm:mb-6 shadow-lg shadow-indigo-500/20`}
                  initial={{ scale: 1, y: 0 }}
                  whileInView={{ 
                    scale: [1, 1.15, 1],
                    y: [0, -10, 0]
