...
function getDefaultStructuredData(siteName: string): SoftwareApplicationSchema {
  return {
    ...
    operatingSystem: "Web",
    description: "AI-powered hiring platform for automated CV screening, candidate interviews, and recruitment management.",
    offers: {
      "@type": "Offer",
      price: "0",
      priceCurrency: "USD",
      name: "Free Tier",
      description: "Get started with AI-powered hiring for free"
    },
    author: {
      "@type": "Organization",
      name: siteName
...
export function SEOHead({
  ...
  const effectiveSiteName = ogSiteName || branding.app_name;
