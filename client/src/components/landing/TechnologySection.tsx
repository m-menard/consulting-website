...
const TechFeature = ({ icon, title, description, delay }: TechFeatureProps) => (
  ...
  >
    <div className="w-12 h-12 rounded-xl bg-indigo-900/50 border border-indigo-800/50 flex items-center justify-center shrink-0">
...
export function TechnologySection() {
  ...
  return (
    <section 
      ref={ref}
      className="py-20 md:py-32 bg-gradient-to-b from-indigo-950 via-indigo-900 to-indigo-950" 
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-900/30 border border-indigo-800/50 mb-6">
            ...
            <Link href="/login">
              <Button 
                className="bg-indigo-500 hover:bg-indigo-600 text-white font-semibold border-0 h-12 px-8 rounded-full shadow-lg shadow-indigo-500/25"
